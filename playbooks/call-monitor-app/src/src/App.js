/**
 * Webex Embedded App (Sidebar) — Call Monitor sample
 *
 * Subscribes to sidebar:callStateChanged via @webex/embedded-app-sdk loaded from
 * public/index.html, and attaches mock CRM data (Faker) to calls.
 *
 * Does not call a real CRM API, persist customer data, or include production
 * hardening (retries, auth to backends, etc.).
 *
 * Optional environment variables — see env.template in the project root folder
