/**
 * Validates headers on GET /api/token. Align FROM, SOURCE_IP, PASSPHRASE, and ORG_ID with env.template
 * and with what Flow Designer sends (see Webex WxCC security documentation for datacenter IPs).
 *
