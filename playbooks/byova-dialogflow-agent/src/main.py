...
# Add project root, core, and generated (for bare proto imports) to Python path
...
from generated.voicevirtualagent_pb2_grpc import add_VoiceVirtualAgentServicer_to_server
