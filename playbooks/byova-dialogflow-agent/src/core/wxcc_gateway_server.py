...
from generated.byova_common_pb2 import (
    DTMFDigits,
    DTMFInputConfig,
    EventInput,
    InputHandlingConfig,
...
from generated.voicevirtualagent_pb2 import (
    Prompt,
    VoiceVAInputMode,
    VoiceVARequest,
    VoiceVAResponse,
)
from generated.voicevirtualagent_pb2_grpc import VoiceVirtualAgentServicer
