...
/*
 * OAuth2 client security for Webex CC: login, logout, and token exchange with
 * self_contained_token=true on the access_token request (WxCC requirement).
 *
 * Env: same as WebexccApplication (WXCC_OAUTH_* and SERVER_PORT). See env.template.
 */
