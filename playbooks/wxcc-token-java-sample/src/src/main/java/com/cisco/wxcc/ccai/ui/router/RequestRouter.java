...
/*
 * Functional route for GET /userinfo — returns JSON with user claims and Bearer access
 * token from the authorized OAuth2 client. Requires an authenticated session.
 */
